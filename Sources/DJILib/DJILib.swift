...
public class DJILib {
    ...
    public func getAuthCommand(pin: String) -> Data{
        ...
        print("PARITY CHECK")
        print("RawCommand is \(rawCommand.hexEncodedString())")
        print("Generated command is \(fullPayload?.hexEncodedString())")
        return fullPayload!
    }
    ...
    public func get_initiate_broadcast_command() -> Data {
        // Working oa4: Data([0x55, 0x0E, 0x04, 0x66, 0x02, 0x08, 0x12, 0x8C, 0x40, 0x02, 0xE1, 0x1A, 0x11, 0xDF])
        // Working oa5p: Data([0x55, 0x12, 0x04, 0xC7, 0x02, 0x88, 0xB8, 0xEB, 0x40, 0x00, 0x32, 0x31, 0x31, 0x00, 0x00, 0x00, 0xE4, 0xEB])
        // The oa5p one doenst seem to work on oa4)
        
        //if(model == .oa5pro){
            //return Data([0x55, 0x12, 0x04, 0xC7, 0x02, 0x88, 0xB8, 0xEB, 0x40, 0x00, 0x32, 0x31, 0x31, 0x00, 0x00, 0x00, 0xE4, 0xEB])
        //}
    ...
    static func getModelFromManufacturerData(manufacturerData: Data) -> Model? {
